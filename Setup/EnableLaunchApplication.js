...
var filename = "SPMonitor.exe";	// The name of the executable to launch - change this to match the file you want to launch at the end of your setup. Doesn't work if the EXE needs UAC elevation!
